...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlightsforbulletentries}
            ...
            \item 적극적으로 문제를 해결하기 위해 노력합니다. 팀에서 불편해하는 사항을 개선하거나 생산성 향상을 위해서 자발적으로 사이드 프로젝트를 진행한 경험이 있습니다.
    ...
    \begin{twocolentry}{
        ...
        \begin{highlights}
            ...
            \item \textbf{카카오페이 기술블로그 게시}, \footnotesize{\href{https://tech.kakaopay.com/post/jack-k8s-internals-part-1/}{쓰기만 했던 개발자가 궁금해서 찾아본 쿠버네티스 내부}}
