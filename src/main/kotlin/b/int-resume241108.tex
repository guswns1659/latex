...
\usepackage{fontspec}
\usepackage{luatexko}
% 새폰트 적용하려면 다운받고 /Library/Fonts 내에 폰트 파일이 존재해야함
% font 캐시 날리고 reload 명령어 실행 필요
% 1. luaotfload-tool --update --force
% 2. fc-cache -fv

% path 지정하는법 1
%\setmainfont[
%    UprightFont = *-Regular,      % 일반체
%    BoldFont = *-Bold,            % 굵은체
%%    ItalicFont = *-Italic,        % 기울임체
%%    BoldItalicFont = *-BoldItalic % 굵은 기울임체
%]{MaruBuri}

% path 지정하는 법2
%\setmainfont[
%    Path = {/Users/yourusername/Library/Fonts/},
%    UprightFont = {NanumSquareRoundR.ttf},
%    BoldFont = {NanumSquareRoundB.ttf},
%    ItalicFont = {NanumMyeongjo-Italic.ttf},
%    BoldItalicFont = {NanumMyeongjo-BoldItalic.ttf}
%]{NanumSquareRoundR}
...
%    \placelastupdatedtext
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \item \textbf{성과} : 적금 계좌 \textbf{35,000건} 이상 개설
            \item \textbf{역할} :
            \begin{highlights}
                \item 분산 트랜잭션으로 나눠진 송금 기능을 안정적으로 개발하여 \textbf{송금 300만건} 정상 처리
                \item 은행 지연 및 장애 대비 서킷브레이커 적용
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \item \textbf{역할} :
            \begin{highlights}
                \item 논블록킹 리액티브 프로그래밍으로 일반 동기 호출 대비 레이턴시 3초 -> 0.5초로 개선
                \item 카프카를 이용한 비동기 프로그래밍으로 높은 처리량과 빠른 응답 보장
            \end{highlights}
        }
        \end{highlights}
    \end{twocolentry}
