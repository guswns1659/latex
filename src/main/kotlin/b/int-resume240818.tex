...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlightsforbulletentries}
            ...
            \item 2주 단위 스프린트 플래닝과 회고를 통해 점진적 발전을 추구하고 페어 프로그래밍 도입하여 코드 품질 향상을 위해 노력합니다

            \item 적극적으로 문제를 해결하기 위해 노력합니다. 주어진 업무가 아니라도 자발적으로 팀 내에서 불편한 사항들이나 도움될만한 건들은 개별 프로젝트로 진행했습니다
    ...
    \begin{twocolentry}{
        ...
        \begin{highlights}
            ...
            \item \textbf{\footnotesize 무결성 시스템 개발 역량} : {\scriptsize 금액 무결성을 위한 데이터 검증 역량, 재처리 프로세스, 동시성 관리, 멱등적 API 설계}
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \item \textbf{역할} :
            \begin{highlights}
                \item UTC+1 차이를 고려한 정확한 데이터 검증 작업 및 개발 진행
                \item 중복 호출 시에도 정상적인 동작을 위한 멱등적 API 설계
                \item 해외 금융사 개발 담당자와 API 및 네트워크 통신을 위한 커뮤니케이션 담당
            \end{highlights}
        }
        \end{highlights}
    \end{twocolentry}
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \item \textbf{성과} : 적금 계좌 \textbf{20,000건} 이상 개설
            \item \textbf{역할} :
            \begin{highlights}
                \item 적금 계좌로 송금 기능 개발과 잔액 정합성을 위한 재처리 프로세스 및 데이터 검증 프로세스 개발
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \item \textbf{역할} :
            \begin{highlights}
                \item webflux 병렬성 이용하여 일반 동기호출 대비 레이턴시 3초 -> 0.5초로 개선
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \item \textbf{성과} : 잔액 정합성 유지하며 \textbf{45,000건/시간, 13TPS 트래픽 처리, 약 13억/일 충전금액} 증대
            \item \textbf{역할} :
            \begin{highlights}
