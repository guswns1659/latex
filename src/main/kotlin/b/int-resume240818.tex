...
\begin{document}
    ...
    \begin{twocolentry}{
        ...
        \begin{highlights}
            ...
            \item \textbf{\footnotesize 테크핀 도메인 역량} : {\scriptsize 충전, 송금, 신한은행 등 외부사와 금융 제휴 상품 개발}
            \item \textbf{\footnotesize 무결성 시스템 개발 역량} : {\scriptsize 금액 무결성을 위한 대사 작업, 재처리 프로세스, 동시성 관리, 멱등적 API 설계}
    ...
    \begin{twocolentry}{
        ...
        \textbf{실시간 택스 리펀 프로젝트} : {\footnotesize 카카오페이 통해서 즉시 부가세를 환급받는 프로젝트}
        \begin{highlights}
            \begin{highlights}
    ...
    \begin{twocolentry}{
        ...
        \textbf{쓸수록 모이는 소비적금 프로젝트} : {\footnotesize 결제한 금액의 일부를 적금으로 모아주는 프로젝트}
        \begin{highlights}
