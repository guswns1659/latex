...
\begin{document}
    ...
    \begin{twocolentry}{
        ...
        \begin{highlights}
            ...
            \item \textbf{주식 미수금액용 충전 프로젝트} | 평균 초당 13건 발생하는 미수금을 위한 충전 기능 제공하여 주식 사용자 편리성 강화
            \item \textbf{마이데이터 계좌 송금 프로젝트} | 연결된 마이데이터 계좌에서 타 계좌로 송금할 수 있는 기능 제공해 트래픽 증대에 기여한 프로젝트
