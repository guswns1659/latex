...
%    \placelastupdatedtext
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item 금융 도메인에서 높은 데이터 정합성을 달성하는 개발 역량
            \item aa
            \item aa
            \item aa
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \begin{highlights}
                ...
                \item RSA + SHA-256을 이용하여 데이터 무결성 및 서명 검증
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \item \textbf{역할} :
            \begin{highlights}
                \item 적금 계좌로 송금 기능 개발할 때 MSA로 인해 분산된 트랜잭션 처리를 위한 SAGA패턴 적용
    ...
    \begin{twocolentry}{
        ...
        {\footnotesize
            ...
            \begin{highlights}
                ...
                \item 일부 계좌 타임아웃 시 카프카 Retry topic 활용
            \end{highlights}
        }
        \end{highlights}
    \end{twocolentry}
